...
`leadr` is intended to be used within a R project for one dataset. Currently, the leaderboard works best placed at the project root, with any number of subdirectories to save the models.
